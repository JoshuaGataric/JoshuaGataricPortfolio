...
page = st.sidebar.selectbox(
    "Select a page",
    ["Home","Hobbies", "Forecasting Traffic Volume","Wine Tasting Model Training", "NFL Combine Analysis","THE GAME Corpus Construction","2022 World Cup Analysis","Stadium Seat Booking System"]
)
