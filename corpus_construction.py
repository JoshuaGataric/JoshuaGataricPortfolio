...
# Overview Section
st.write("""
This project analyzes media outlet reactions to Michigan’s 30-24 victory over Ohio State during the 2023 college football season, emphasizing linguistic trends that shape narratives around high-stakes sports rivalries. By building a custom corpus with articles from ESPN, FOX SPORTS, and CBS SPORTS, I explore recurring patterns in language through collocation analysis, highlighting the cultural intensity and significance of "THE GAME."
